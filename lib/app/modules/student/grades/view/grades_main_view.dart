...
import '../controllers/grades_tab_controller.dart';
import 'attendance_calendar_screen.dart';
import 'attendance_leave_request_screen.dart';
import 'attendance_overview_screen.dart';

class GradesMainView extends StatelessWidget {
  GradesMainView({super.key});
  final GradesTabController controller = Get.put(GradesTabController());
  ...
  Widget _buildSegmentButton(
    ...
    required int index,
    required GradesTabController controller,
  }) {

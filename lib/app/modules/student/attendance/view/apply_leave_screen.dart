                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                              ...
                              child: TextField(
                                controller: TextEditingController(
                                  text: controller.selectedDateRange.value == null
                                      ? ''
                                      : '${DateFormat('MMM d, yyyy').format(controller.selectedDateRange.value!.start)} - ${DateFormat('MMM d, yyyy').format(controller.selectedDateRange.value!.end)}',
                                ),
                                decoration: const InputDecoration(
                                  hintText: 'Select Date Range',
                                  border: InputBorder.none,
                        ...
                        // "1 Day" button - can be implemented with logic to set date range to 1 day
                        Padding(
                          padding: const EdgeInsets.only(right: 8.0),
                          child: ElevatedButton(
                            onPressed: () {
                  ...
                  Container(
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton<String>(
                        ...
                        items: controller.availableLeaveTypes.map<DropdownMenuItem<String>>((String value) {
                          return DropdownMenuItem<String>(
                            value: value,
                            child: Padding(
                              padding: const EdgeInsets.symmetric(horizontal: 16.0),
                              child: Text(value.capitalizeFirst!), // Capitalize for display
                            ),
                          );
                        }).toList(),
                      ),
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: 16),
                        OutlinedButton(
                          onPressed: () => controller.pickSupportingDocument(),
                          style: OutlinedButton.styleFrom(
                            foregroundColor: Colors.grey[700],
                            side: BorderSide(color: Colors.grey[400]!),
                            shape: RoundedRectangleBorder(
                        ...
                        Obx(() {
                          ...
                          return Padding(
                            ...
                            child: Column(
                              children: controller.supportingDocuments
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: OutlinedButton(
                          onPressed: () {
                            controller.resetApplyLeaveForm();
                            Get.back(); // Go back
                          },
                          style: OutlinedButton.styleFrom(
                            foregroundColor: Colors.grey[700],

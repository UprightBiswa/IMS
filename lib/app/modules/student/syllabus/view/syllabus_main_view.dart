...
import '../controllers/syllabus_tab_controller.dart';
import 'attendance_calendar_screen.dart';
import 'attendance_leave_request_screen.dart';
import 'attendance_overview_screen.dart';

class SyllabusMainView extends StatelessWidget {
  SyllabusMainView({super.key});
  final SyllabusTabController controller = Get.put(SyllabusTabController());
  ...
  Widget _buildSegmentButton(
    ...
    required int index,
    required SyllabusTabController controller,
  }) {

...
class AppColors {
  ...
  static const Color bottomBarBlue = Color(0xFF3949AB);


  static const Color lightGreyBackground = Color(0xFFF0F2F5); // General light grey background
  static const Color darkText = Color(0xFF212121); // Dark text
  static const Color greyText = Color(0xFF757575); // Grey text
  static const Color lightBlue = Color(0xFFE3F2FD); // For calendar selected circle
  static const Color accentBlue = Color(0xFF42A5F5); // For calendar selected circle border
  ...
  static const Color leaveCalendarDot = Color(0xFFAB47BC); // Purple dot (example, adjust if different in image)
